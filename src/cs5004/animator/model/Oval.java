...
/**
 * This class represents an Oval. It has all of the operations mandated by the IShape interface and
 * extends the Abstract Shape implementation.
 */
public class Oval extends AbstractShape {

  /**
   * Constructs an Oval object with a name, x position, y position, width, height, and color.
   *
   ...
   */
  public Oval(String name, double xPos, double yPos,
